...
\item
Investigation of batch effects by repeating of metagene extraction and heatmaps on the \emph{combined} AOCS and TCGA datasets.
\end{enumerate}
...
\subsection{Metagene extraction by cluster coherence}
