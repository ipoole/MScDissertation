...
\begin{figure}[htb!]
\begin{center}
\includegraphics[scale=0.1]{\plotspath{TCGA_OV_VST/GeneEnrichment/go_lineage_1_of_NMF_3.png}} \\
\begin{spacing}{0.6}
...
\section{Matrix factorization discovers and effectively removes batch effects}

Here are presented results of applying the three MF methods to the combined AOCS and TCGA datasets. 



\begin{figure}[htb!]
\begin{center}
\includegraphics[scale=0.7, draft=false]{\plotspath{HeatMaps/clustered_heatmap_BOTH_BOTH.pdf}} 
...
\begin{figure}[htb!]
\begin{center}
\includegraphics[scale=0.6]{\plotspath{BoxAndScatters/wgd_boxplot_NMF_BOTH_BOTH.pdf}}
\includegraphics[scale=0.6]{\plotspath{BoxAndScatters/wgd_boxplot_ICA_BOTH_BOTH.pdf}}
\includegraphics[scale=0.6]{\plotspath{BoxAndScatters/wgd_boxplot_PCA_BOTH_BOTH.pdf}}
...
\begin{figure}[htb!]
\begin{center}
\includegraphics[scale=0.5]{\plotspath{SurvivalAnalysis/multiple_kaplan_meier_os_BOTH_BOTH.pdf}} 
\caption{Kaplan-Meier plots for each metasample component, stratified at the median value, for the combined AOCS + TCGA dataset}
\label{fig-kaplan-meier-os-BOTH}
\end{center}
\end{figure}
