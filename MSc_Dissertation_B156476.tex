...
\subsection{Gene Enrichment Results}
...
\vspace{1cm}
\includegraphics[scale=0.08]{\plotspath{TCGA_OV_VST/GeneEnrichment/go_lineage_5_of_ICA_5.png}} \\
\begin{spacing}{0.6}
...
\begin{center}
\includegraphics[scale=0.075]{\plotspath{TCGA_OV_VST/GeneEnrichment/go_lineage_4_of_ICA_5.png}} \\
\begin{spacing}{0.6}
...
\end{spacing}
\vspace{0.5cm}
\caption{Lineage maps of enriched Gene Ongology (GO) terms for components 4 from the rank=5 ICA factorization. }
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.1]{\plotspath{TCGA_OV_VST/GeneEnrichment/go_lineage_1_of_PCA_3.png}} \\
...
\vspace{1cm}
\includegraphics[scale=0.09]{\plotspath{TCGA_OV_VST/GeneEnrichment/go_lineage_3_of_PCA_3.png}} \\
\begin{spacing}{0.6}
