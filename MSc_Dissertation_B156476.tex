...
In this work we wish to treat and discuss the three factorization methods in a unified way.  Thus, for the remainder of this dissertation we adopt the following conventions:\footnote{I should probably use bold font for X, W and H matrices}.
\begin{description}
