...
To take full advantage of the hierarchical nature of the GO, results are presented as lineage maps in figures \ref{fig-NMF-go-lineage} to \ref{fig-PCA-1-3-genesiso-lineage}.  
...
\caption{Heatmap of the metasamples matrix for the AOCS dataset, computed from metagenes factorized from the TCGA dataset.   Several patient metadata variables are shown in columns to the left.  (ToDo: key for metadata colouring).}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[scale=0.6, draft=false]{\plotspath{BoxAndScatters/wgd_boxplot_NMF_TCGA_AOCS.pdf}}
\includegraphics[scale=0.6, draft=false]{\plotspath{BoxAndScatters/wgd_boxplot_ICA_TCGA_AOCS.pdf}}
\includegraphics[scale=0.6, draft=false]{\plotspath{BoxAndScatters/wgd_boxplot_PCA_TCGA_AOCS.pdf}}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[scale=0.54, draft=false]{\plotspath{BoxAndScatters/genomic_feature_scatters_TCGA_AOCS.pdf}} 
