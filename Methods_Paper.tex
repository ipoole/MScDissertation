...
\documentclass[tikz, 11pt,a4paper,oneside,fleqn]{article}
...
\graphicspath{{/home/ipoole/Documents/gitrepos/MScDissertation/images/}}  % trailing '/' is required!
...
\begin{figure}[htb!]
\begin{center}
\includegraphics[scale=\S]{multiple_single_factors_scatter_AOCS_ICA_2_3_5_10_fixed.pdf} \\
\includegraphics[scale=\S]{multiple_single_factors_scatter_AOCS_ICA_2_3_5_10_bootstrap.pdf}\\
...
\begin{figure}[htb!]
\begin{center}
\includegraphics[scale=\S]{multiple_single_factors_scatter_TCGA_ICA_2_3_5_10_fixed.pdf} 
\includegraphics[scale=\S]{multiple_single_factors_scatter_TCGA_ICA_2_3_5_10_bootstrap.pdf}
...
\begin{figure}[htb!]
\begin{center}
\includegraphics[scale=\S]{multiple_single_factors_scatter_TCGA_NMF_2_3_5_10_bootstrap.pdf} \\
\includegraphics[scale=\S]{multiple_single_factors_scatter_TCGA_ICA_2_3_5_10_bootstrap.pdf} \\
\includegraphics[scale=\S]{multiple_single_factors_scatter_TCGA_PCA_2_3_5_10_bootstrap.pdf} \\
\includegraphics[scale=0.55]{silhouette_plots_TCGA_2_3_4_5_6_7_8_9_10_bootstrap.pdf} 
...
\begin{figure}[htb!]
\begin{center}
\includegraphics[scale=0.08]{go_lineage_1_of_NMF_3.png} \\
\begin{spacing}{0.6}
{\small Genes: \tiny \input{inputs/TCGA_go_gene_set_1_of_NMF_3.txt}}
\end{spacing}
\vspace{0.5cm}
...
\begin{figure}[htb!]
\begin{center}
\includegraphics[scale=0.1]{go_lineage_2_of_NMF_3.png} \\
\begin{spacing}{0.6}
{\small Genes: \tiny \input{inputs/TCGA_go_gene_set_2_of_NMF_3.txt}}
\end{spacing}
\vspace{0.5cm}
...
\begin{figure}[htb!]
\begin{center}
\includegraphics[scale=0.09]{go_lineage_3_of_ICA_5.png} \\
\begin{spacing}{0.6}
{\small Genes: \tiny \input{inputs/TCGA_go_gene_set_3_of_ICA_5.txt}}
\end{spacing}
\vspace{0.5cm}
...
\begin{figure}[htb!]
\begin{center}
\includegraphics[scale=0.06]{go_lineage_5_of_ICA_5.png} \\
\begin{spacing}{0.6}
{\small Genes: \tiny \input{inputs/TCGA_go_gene_set_5_of_ICA_5.txt}}
\end{spacing}
\vspace{0.5cm}
...
\begin{figure}[htb!]
\begin{center}
\includegraphics[width=0.4 \textwidth]{go_lineage_1_of_PCA_3.png} \\
\begin{spacing}{0.6}
{\small Genes: \tiny \input{inputs/TCGA_go_gene_set_1_of_PCA_3.txt}}
\end{spacing}
\vspace{0.5cm}
...
\begin{figure}[htb!]
\begin{center}
\includegraphics[width= 0.7\textwidth]{go_lineage_3_of_PCA_3.png} \\
\begin{spacing}{0.6}
{\small Genes: \tiny \input{inputs/TCGA_go_gene_set_3_of_PCA_3.txt}}
\end{spacing}
\vspace{0.5cm}
...
\begin{figure}[htb!]
\begin{center}
\includegraphics[scale=0.45]{genomic_feature_scatters_TCGA_AOCS.pdf}
...
\begin{figure}[htb!]
\begin{center}
\includegraphics[scale=0.4,draft=false]{clustered_heatmap_BOTH_BOTH.pdf}
\end{center}
...
\begin{figure}[htb!]
\begin{center}
\includegraphics[scale=0.36]{wgd_boxplot_NMF_BOTH_BOTH.pdf}
\includegraphics[scale=0.36]{wgd_boxplot_ICA_BOTH_BOTH.pdf}
\includegraphics[scale=0.36]{wgd_boxplot_PCA_BOTH_BOTH.pdf}
\end{center}
